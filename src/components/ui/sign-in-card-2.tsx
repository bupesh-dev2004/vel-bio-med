                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="flex items-center justify-between pt-1">
                    ...
                    <div className="text-xs relative group/link">
                      <a href="#forgot" onClick={(e) => e.preventDefault()} className="text-white/60 hover:text-white transition-colors duration-200">
                        Forgot password?
                      </a>
                    </div>
                  </div>
                  ...
                  <motion.button
                    ...
                    type="submit"
                    disabled={isLoading}
                    className="w-full relative group/button mt-5 border-none bg-transparent cursor-pointer"
                  >
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    type="button"
                    className="w-full relative group/google border-none bg-transparent cursor-pointer"
                  >
